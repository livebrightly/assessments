...
class BaseRenderer(object):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.wrapper_class = kwargs.get(
            "wrapper_class", get_bootstrap_setting("wrapper_class"))
        ...
        self.checkbox_style = kwargs.get(
            "checkbox_style", get_bootstrap_setting("checkbox_style"))
        self.horizontal_field_offset_class = kwargs.get(
            "horizontal_field_offset_class", get_bootstrap_setting(
        ...
        self.server_side_validation = kwargs.get(
            "server_side_validation", get_bootstrap_setting(
...
class FormRenderer(BaseRenderer):
    ...
    def render_errors(self, type="all"):
        ...
        if form_errors:
            return render_template_file(
                "django_bootstrap5/form_errors.html",
                context={"errors": form_errors, "form": self.form,
                         "layout": self.layout, "type": type},
            )
...
class FieldRenderer(BaseRenderer):
    ...
    def __init__(self, field, *args, **kwargs):
        ...
        self.help_text = text_value(
            field.help_text) if self.show_help and field.help_text else ""
        self.field_errors = [conditional_escape(
            text_value(error)) for error in field.errors]

        self.placeholder = text_value(kwargs.get(
        ...
        self.addon_before_class = kwargs.get(
            "addon_before_class", self.widget.attrs.pop(
                "addon_before_class", "input-group-text")
        )
        self.addon_after_class = kwargs.get(
            "addon_after_class", self.widget.attrs.pop(
                "addon_after_class", "input-group-text")
        )
        ...
        self.error_css_class = (
            getattr(field.form, "error_css_class",
        ...
        self.required_css_class = (
            getattr(field.form, "required_css_class",
        ...
        self.success_css_class = (
            getattr(field.form, "success_css_class",
    ...
    #     classes = [widget.attrs.get("class", "")]
        ...
        if size_prefix:
            classes.append(get_size_class(
                self.size, prefix=size_prefix, skip=["xs", "md"]))
    ...
    def add_placeholder_attrs(self, widget=None):
        ...
        if placeholder and self.set_placeholder and is_widget_with_placeholder(widget):
            widget.attrs["placeholder"] = conditional_escape(
                strip_tags(placeholder))
    ...
    def render(self):
        ...
        if self.is_form_control_widget():
            addon_before = (
                format_html('<span class="input-group-text">{}</span>',
            ...
            if addon_before or addon_after:
                ...
                field = format_html('<div class="{}">{}{}{}{}</div>',
                                    classes, addon_before, field, addon_after, errors)
                errors = ""

        if isinstance(self.widget, CheckboxInput):
            field = format_html('<div class="{}">{}{}{}</div>',
                                self.get_checkbox_classes(), field, errors, help)
            errors = ""
            help = ""
